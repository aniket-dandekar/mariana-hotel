...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($con, "Update doctors set r_name='$r_name',r_type='$r_type',r_price='$r_price' where id='$did'");
	if ($sql) {
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											...
											<div class="panel-body">
												<?php $sql = mysqli_query($con, "select * from room_type_details where id='$did'");
